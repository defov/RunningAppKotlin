...
import com.example.myrun.other.CustomMarkerView
import com.example.myrun.other.TrackingUtility
import com.example.myrun.ui.viewmodels.StatisticsViewModel
...
class StatisticsFragment: Fragment(R.layout.fragment_statistics) {
    ...
    private fun subscribeToObservers() {
        ...
        viewModel.totalDistance.observe(viewLifecycleOwner, Observer {
            it?.let {
                val kilometers = it / 1000f
                val totalDistance = round(kilometers * 10f) / 10f
