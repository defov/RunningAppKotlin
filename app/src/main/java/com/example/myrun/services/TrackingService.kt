package com.example.myrun.services
...
import com.example.myrun.other.Constants.FASTEST_LOCATION_INTERVAL
import com.example.myrun.other.Constants.LOCATION_UPDATE_INTERVAL
import com.example.myrun.other.Constants.NOTIFICATION_CHANNEL_ID
import com.example.myrun.other.Constants.NOTIFICATION_CHANNEL_NAME
import com.example.myrun.other.Constants.NOTIFICATION_ID
import com.example.myrun.other.Constants.TIMER_UPDATE_INTERVAL
import com.example.myrun.other.TrackingUtility
import com.example.myrun.ui.MainActivity
...
//                        serviceKilled = false
                ...
                ACTION_STOP_SERVICE -> {
                    ...
                    Log.d(TAG, "Should be never invoked")
                }
            }
        }
        ...
        timeRunInSeconds.observe(this, Observer {
            if(!serviceKilled) {
                val notification = currentNotificationBuilder
                        .setContentText(TrackingUtility.getFormatedStopWatchTime(it * 1000))
